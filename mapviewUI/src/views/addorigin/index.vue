    ...
    <div id="declare">
        <div class="add-origin-view">
            ...
            <div class="function-button">
                ...
                <el-button style="margin-top: 10px;" @click="onClickAdd">添加地址</el-button>
...
import { createAddress, search } from "@/api/address"
import platform from "./platform"


// 广东省东莞市长安镇大井街58号质佳数控车床加工
...
async function onClickAdd() {
    ...
    await createAddress(name, detailed, locationTable);
