<template>
	<div class="main-wrap">
		...
		<div class="main-content " :class="{ 'user-pc': !ISMOBILE }">
			...
			<div class="title-wrap independent ">
				<topFunction />
			...
			<div class="table-wrap" ref="tableWrap">
				<div class="content" :style="translateX">
					<machine v-for="item in listMachine" :key="item.mid" :data="item"  :clickDeleOrder="clickDeleOrder" :autoButton="autoButton" />
				</div>
				<latex v-model="listMachine" v-if="latexShow" />
			</div>

			<bottom :match="listMachine[offsetIndex]" />
		</div>
...
import { listMachine, selectValue, showOverlay, ISMOBILE, autoButton, offsetIndex, switchOverlay, init, getNextOrder } from "@/layout/hooks/userData"
import { dialogTail, tailForm, tailing, tailerror } from "@/layout/hooks/userTail"
