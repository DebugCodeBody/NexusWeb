    ...
    <div class="wh-full  overflow-hidden ">
        ...
        <div class="wh-full flex flex-col overflow-hidden ">
            ...
            <div class="flex mb-10px">
                ...
                <div>
                    <el-select v-model="selectMonth" @change="onMountChange">
...
const Api = {
    ...
    async index(filter: any): Promise<any> {
        ...
        const [err, data] = await to(getHead(selectMonth, selectVal));
...
function onSelectChange(value:any) {
    ...
    selectItem.head.type = value;

    baTable.Refresh();
}

function onMountChange(value:any){
